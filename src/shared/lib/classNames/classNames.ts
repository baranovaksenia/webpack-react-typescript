...
/**
 * Generate a space-separated string of CSS
 * classes based on a base class, modifiers, and additional classes.
 *
 * @param cls - The base CSS class.
 * @param mods - An object of class
 * modifiers where keys represent class names and values indicate inclusion (true)
 * or exclusion (false) of the class.
