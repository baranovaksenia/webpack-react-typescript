...
/**
 * Represents a custom type 'Mods' which defines CSS class modifications.
 * 'Mods' is an object that maps class names (keys) to values that can be either booleans or strings.
 */
type Mods = Record<string, boolean | string>;

/**
 * Generates a space-separated string of CSS classes based on a base class, modifiers, and additional classes.
 *
